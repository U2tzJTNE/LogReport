 ...
 */
package com.u2tzjtne.logrepoter.core.upload;
...
public abstract class BaseUpload implements ILogUpload {
    ...
    public final static SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SS", Locale.getDefault());
    ...
    public String buildTitle(Context context) {
        return "【CrashLog】  " + context.getString(context.getApplicationInfo().labelRes) + " " + DATE_FORMAT.format(Calendar.getInstance().getTime());
    }
